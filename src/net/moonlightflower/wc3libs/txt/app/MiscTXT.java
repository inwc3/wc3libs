...
public class MiscTXT extends TXT {
	...
	public static class States {
		...
		public final static State<DataList<Int>> EXP_HERO_NEEDED = new State<>(Section.MISC, "NeedHeroXP");
		...
		public final static State<DataList<Int>> EXP_GRANTED_HERO = new State<>(Section.MISC, "GrantHeroXP");
		...
		public final static State<DataList<Int>> EXP_GRANTED_NORMAL = new State<>(Section.MISC, "GrantNormalXP");
		...
		public final static State<DataList<Int>> EXP_GRANTED_CREEP_REDUCTION = new State<>(Section.MISC, "HeroFactorXP");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL1_FACTOR = new State<>(Section.TWN1, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL2_FACTOR = new State<>(Section.TWN2, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL3_FACTOR = new State<>(Section.TWN3, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL4_FACTOR = new State<>(Section.TWN4, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL5_FACTOR = new State<>(Section.TWN5, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL6_FACTOR = new State<>(Section.TWN6, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL7_FACTOR = new State<>(Section.TWN7, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL8_FACTOR = new State<>(Section.TWN8, "XPFactor");
		public final static State<DataList<Real>> EXP_GRANTED_TOWNHALL9_FACTOR = new State<>(Section.TWN9, "XPFactor");
		...
		public final static State<DataList<Real>> RESOURCES_SUPPLY_UPKEEP_COSTS_GOLD = new State<>(Section.MISC, "UpkeepGoldTax");
		public final static State<DataList<Real>> RESOURCES_SUPPLY_UPKEEP_COSTS_LUMBER = new State<>(Section.MISC, "UpkeepLumberTax");
		public final static State<DataList<Int>> RESOURCES_SUPPLY_UPKEEP_LEVELS = new State<>(Section.MISC, "UpkeepUsage");

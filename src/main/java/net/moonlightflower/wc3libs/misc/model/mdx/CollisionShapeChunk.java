...
public class CollisionShapeChunk extends Chunk {
    ...
    private final LinkedHashSet<CollisionShape> _collisionShapes = new ObservableLinkedHashSet<>();

    public LinkedHashSet<CollisionShape> getCollisionShapes() {
    ...
    private void read_0x0(@Nonnull Wc3BinInputStream stream) throws BinInputStream.StreamException {
        ...
        while (stream.getPos() < endPos) {
            _collisionShapes.add(new CollisionShape(stream));
        }
    }
